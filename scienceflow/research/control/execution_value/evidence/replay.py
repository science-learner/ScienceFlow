"""Append-only Execution Value decision replay archive."""
...
from scienceflow.research.control.execution_value.decision.contracts import ExecutionValueRecord


class ExecutionValueReplayArchive:
    ...
    def append(self, record: ExecutionValueRecord) -> bool:
...
__all__ = ["ExecutionValueReplayArchive"]
